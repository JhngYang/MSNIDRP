...
def parse_args():
    ...
    parser.add_argument('--embeddings_prefix',type=str,default='',help='describe info of embeddings')
    parser.add_argument('--save_format',type=str,default='mat',help='data format')
